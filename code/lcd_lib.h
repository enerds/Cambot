...
#define LDP PORTF	//define MCU port connected to LCD data pins
#define LCP PORTF	//define MCU port connected to LCD control pins
#define LDDR DDRF	//define MCU direction register for port connected to LCD data pins
#define LCDR DDRF	//define MCU direction register for port connected to LCD control pins
